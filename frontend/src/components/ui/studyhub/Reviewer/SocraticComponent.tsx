            ...
            <main className="relative z-10 flex flex-1 flex-col p-8">
                <section className="rounded-3xl border border-violet-500/20 bg-[#11111a]/90 p-6 shadow-[0_24px_50px_-35px_rgba(46,16,101,0.75)] backdrop-blur">
                    <div className="flex items-center justify-between gap-4">
                        <div>
                            <h1 className="text-3xl font-semibold tracking-tight text-white">Socratic Reviewer</h1>
                    ...
                    {currentQuestion ? (
                        <>
                            ...
                            <h2 className="mt-3 text-3xl font-medium leading-tight text-white">
                                <MathText text={currentQuestion.prompt ?? currentQuestion.question ?? "No question text"} />
                            </h2>

                            {currentQuestion.guidanceHint && (
                                <p className="mt-4 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-zinc-300">
                                    Hint: <MathText text={currentQuestion.guidanceHint} />
                                </p>
                            )}
